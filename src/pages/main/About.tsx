      ...
      <div className="max-w-7xl w-[75%]">
        <div className="flex flex-col md:flex-row gap-8 w-full justify-center items-center mb-3">
          <motion.span
            ...
            className="bg-muted/50 p-6 rounded-xl w-full"
          >
            <h1 className="text-5xl font-extrabold text-primary mb-4">3K+</h1>
            <p className="text-md">
          ...
          <motion.span
            ...
            viewport={{ amount: "some" }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="p-6 bg-muted/50 rounded-xl w-full"
          >
        ...
        <motion.div
          ...
          viewport={{ amount: "some" }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="flex flex-col md:flex-row bg-muted/50 w-full rounded-xl justify-center items-center"
        >
          <span className="h-full w-full md:w-1/2 p-6 flex justify-center items-start flex-col">
            <h1 className="text-3xl font-bold mb-3">No asset volatility</h1>
